...
const CATEGORY_WEIGHTS: Array<{ pattern: RegExp; weight: number }> = [
  // 1. Layout & Display
...
function calculateClassScore(raw: string): number {
 ...
 */
export function sortClasses(classes: string[]): { result: string[]; changes: ClassFixChange[] } {
