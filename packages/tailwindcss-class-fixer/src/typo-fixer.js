...
exports.suggestTypoFix = suggestTypoFix;
exports.fixTypos = fixTypos;
 ...
 */
function suggestTypoFix(className, dictionary = COMMON_TAILWIND_UTILITIES) {
    ...
    if (dictionary.includes(base) || VALID_PREFIX_PATTERN.test(base))
        return null;
 ...
 */
function fixTypos(classes, dictionary) {
    const result = [];
    const changes = [];
