...
exports.migrateClasses = migrateClasses;
 ...
 */
function migrateClasses(classes, targetVersion = 'v4') {
    const changes = [];
    const result = [];
    // Buffer to handle pairing of background/text colors with standalone opacity utilities
    let pendingBgOpacity = null;
    let pendingTextOpacity = null;
    let pendingBorderOpacity = null;
